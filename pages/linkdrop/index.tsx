...
const MAIN_TEXT = 'Hello dear traveler welcome to the page which will guide you through the onboarding process! '  
...
const LinkDrop: NextPage = () => {
  ...
  const FAILURE_MESSAGE = 'Sorry, it seems desired name has already been taken or we ran out of free accounts. ' + 
  'Please contact us on social media or email info@vself.app and we will guide you through onboarding.';
  const SUCCESS_MESSAGE = 'Success! You have claimed your free NEAR account!'
  ...
  return (
    <div className="grid place-items-center h-screen">
      <div className="text-center text-black">
        ...
        <div className="w-96 mb-8">
        To operate your newly registered account use your mnemonic to login to <a href="https://wallet.near.org/">official NEAR wallet</a>
        </div>
